...
Replace this section with the supported versions for `patchproof`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `patchproof` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in patchproof.
